...
<html lang="en">
  ...
  ?>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-6 d-flex flex-column justify-content-center">
              <h1 data-aos="fade-up">NATIONAL BANK </h1>
              <h3 data-aos="fade-up">We’re just the bank you need. </h3>
              <h2 data-aos="fade-up" data-aos-delay="400">One Family One Bank</h2>
            ...
            <div class="col-lg-6 hero-img" data-aos="zoom-out" data-aos-delay="200">
              <img src="img/bank.jpg" class="img-fluid" alt="">
            </div>
          </div>
        </div>
    ...
    -->
      ...
      <footer class="text-center mt-5 py-2 "style= "color:#ffffff;">
